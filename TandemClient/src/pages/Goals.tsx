              ...
              <CardContent className="space-y-4">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    {completionStatus.isComplete && (
                      <span className="text-xs font-semibold text-green-600 flex items-center gap-1.5 bg-green-50 px-2 py-1 rounded-full">
                        <CheckCircle2 className="w-3.5 h-3.5" />
                        Goal Complete!
                      </span>
                    )}
                    {completionStatus.hasMilestones && !completionStatus.allMilestonesComplete && progress >= 100 && (
                      <span className="text-xs font-semibold text-yellow-700 flex items-center gap-1.5 bg-yellow-50 px-2 py-1 rounded-full">
                ...
                {/* Progress Update */}
                <div className="p-5 bg-gradient-to-br from-red-50 to-orange-50 rounded-xl border-2 border-red-200 shadow-sm">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {getQuickAddSuggestions(goal).map((amount, idx) => (
                            <button
                              ...
                              className="px-4 py-2 text-sm font-semibold bg-white border-2 border-red-200 text-red-700 rounded-lg hover:bg-red-50 hover:border-red-400 hover:shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      ...
                      {goal.milestones.map((milestone) => (
                        <button
                          ...
                          className={`w-full flex items-center gap-3 p-4 rounded-xl transition-all shadow-sm ${
                            milestone.completed
                              ? 'bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 hover:from-green-100 hover:to-emerald-100'
                              : 'bg-white border-2 border-gray-200 hover:border-red-500 hover:shadow-md'
                          }`}
                        ...
                        >
                          {milestone.completed ? (
                            ...
                            <Circle className="w-7 h-7 text-gray-400 flex-shrink-0 hover:text-red-600 transition-colors" />
                          )}
                          <span
